...
![Time-varying selectivity estimated for F01 Japan LL area 1 late.](ModelDev/Current%20Best/plots/sel03_len_timevary_surf_flt1sex1.png){#fig-14}

![Time-varying selectivity estimated for F02 Chinese Taipei LL late.](ModelDev/Current%20Best/plots/sel03_len_timevary_surf_flt2sex1.png){#fig-15}

::: {#fig-16 layout-nrow="2"}
...
![Likelihood profile over R0 for the base-case model: total likelihood (black circles), recruitment (blue triangles), length composition data (light blue crosses), and survey/CPUE indices (yellow x).](ModelDev/Current%20Best/plots/r0profile_20230313_1248_1.png){#fig-26}

![Likelihood profile over R0 by CPUE index for the base-case model.](ModelDev/Current%20Best/plots/r0profile_20230313_1248_2.png){#fig-27}

![Likelihood profile over R0 for each length composition time series for the base-case model.](ModelDev/Current%20Best/plots/r0profile_20230313_1248_4.png){#fig-28}
